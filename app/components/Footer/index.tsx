...
export default function Footer() {
  return (
    <div className="pt-12 flex flex-col items-center justify-center bg-black">
      ...
      <div className="flex flex-col font-normal text-xs leading-4 text-[#888888] mb-32 text-center">
        ...
        <span className="mb-5">
          SUPERCASINO only uses cookies which will improve your experience with
          us and will not interfere with your privacy
        </span>
