...
const InformationNotice = ({ title, children }: { title: string; children: React.ReactNode }) => {
    return (
        <div className='mb-5'>
    ...
    return (
        <div className='w-full bg-white px-5 pt-[10px] pb-5 text-[#111111] font-normal text-sm leading-5'>
            ...
            <InformationNotice title='충전단위'>
                ...
                <p>추가 입금을 해 주시거나, M&M 고객센터로 이체 확인증을 제출하시어 확인 후 처리 가능합니다.</p>
            </InformationNotice>
            <InformationNotice title='충전규정'>
                <p>허위충전 시 경고없이 제제됩니다. </p>
                <p>입금 신청 후 최대 5분이내 입금이 완료되지 않을
                    경우 자동 취소됩니다.
                </p>
                <p>
                    반복적인 허위 입금 신청 시 모든 게임 사용 및
                    이벤트 자격이 박탈됩니다.
                </p>
            </InformationNotice>
